...
class PredictorDataset(Dataset):
    def __init__(self, csv_path, tokenizer_name="t5-base", max_len=128, target_max_len=10):
    ...
    def __getitem__(self, idx):
        ...
        input_text = f"predict premise: {row['premise']} hypothesis: {row['hypothesis']} explanation: {row['explanation']}"
